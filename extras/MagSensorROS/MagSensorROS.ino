...
void loop() {
  ...
  if (!magSensor.update()) {
    ...
    //magfield_msg.x = mag_field_avg[0]/static_cast<double>(history_size);
    //magfield_msg.y = mag_field_avg[1]/static_cast<double>(history_size);
    //magfield_msg.z = mag_field_avg[2]/static_cast<double>(history_size);
    //pub_field.publish(&magfield_msg);
    //nh.spinOnce();
